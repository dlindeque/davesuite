...
namespace davecommon
{
    ...
    class logger {
    protected:
        virtual auto write(severity s, const std::shared_ptr<container> &cntr, const span &spn, const std::wstring &msg) -> void = 0;
    public:
        logger() {}
    ...
    private:
        logger *_decorated;
    protected:
        inline auto write_decorated(severity s, const std::shared_ptr<container> cntr, const span &spn, const std::wstring &msg) -> void {
