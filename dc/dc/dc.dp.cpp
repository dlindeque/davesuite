...
namespace dc
{
    ...
    struct lexical_value {
        ...
        span tkn_span;
         ...
         spantext Str;
        lexical_value() { }
        lexical_value(span &&spn, const TokenType _tkn_type, const std::wstring &_tkn_value)
        : desc(text(_tkn_type)), tkn_span(std::move(spn)), tkn_type(_tkn_type), tkn_value(_tkn_value)
        {}
        lexical_value(span &&spn, const TokenType _tkn_type, std::wstring &&_tkn_value)
        ...
        {}
        lexical_value(const lexical_type::EnumItems&,  std::vector<spantext>&& value)
            ...
            switch(states.back()) {
                case 0:
                    switch(s.token) {
                        case TokenType::Namespace:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Namespace, std::move(s.value));
                            states.push_back(2);
                            read_token = true;
                            break;
                        case TokenType::Set:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Set, std::move(s.value));
                            states.push_back(3);
                            read_token = true;
                            break;
                        case TokenType::Import:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Import, std::move(s.value));
                            states.push_back(4);
                            read_token = true;
                            break;
                        default:
                            ...
                            if(true) {
                                ...
                                log::error::UnexpectedToken(logger, cntr, s.begin, s.end, s.token, s.value, validTokens);
                                return false;
                            }
                            break;
                    }
                ...
                case 2:
                    switch(s.token) {
                        case TokenType::Identifier:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Identifier, std::move(s.value));
                            states.push_back(11);
                            read_token = true;
                            break;
                        default:
                ...
                case 3:
                    switch(s.token) {
                        case TokenType::Start:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Start, std::move(s.value));
                            states.push_back(9);
                            read_token = true;
                            break;
                        default:
                ...
                case 4:
                    switch(s.token) {
                        case TokenType::String:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::String, std::move(s.value));
                            states.push_back(6);
                            read_token = true;
                            break;
                        default:
                ...
                case 5:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(); i1.DocumentItem->accept(processor); if(!ok) return false;
                        read_token = false;
                        switch(states.back()) {
                ...
                case 7:
                    switch(s.token) {
                        case TokenType::Semicolon:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Semicolon, std::move(s.value));
                            states.push_back(8);
                            read_token = true;
                            break;
                        default:
                ...
                case 8:
                    ...
                    if (true) {
                        ...
                        switch(states.back()) {
                            ...
                            case 1: states.push_back(112); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                case 9:
                    switch(s.token) {
                        case TokenType::Equals:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Equals, std::move(s.value));
                            states.push_back(10);
                            read_token = true;
                            break;
                        default:
                ...
                case 11:
                    ...
                    if (true) {
                        ...
                        switch(states.back()) {
                            ...
                            case 19: states.push_back(107); break;
                            case 21: states.push_back(73); break;
                            case 22: states.push_back(65); break;
                            case 24: states.push_back(25); break;
                            case 30: states.push_back(12); break;
                            case 42: states.push_back(12); break;
                            case 66: states.push_back(67); break;
                            case 69: states.push_back(72); break;
                            case 75: states.push_back(12); break;
                            case 82: states.push_back(12); break;
                            case 84: states.push_back(85); break;
                            case 85: states.push_back(12); break;
                            case 88: states.push_back(89); break;
                            case 89: states.push_back(12); break;
                            case 93: states.push_back(94); break;
                            case 94: states.push_back(12); break;
                            case 98: states.push_back(12); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                case 12:
                    ...
                    if (true) {
                        ...
                        switch(states.back()) {
                            ...
                            case 75: states.push_back(97); break;
                            case 82: states.push_back(92); break;
                            case 85: states.push_back(86); break;
                            case 89: states.push_back(90); break;
                            case 94: states.push_back(95); break;
                            case 98: states.push_back(102); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                case 13:
                    switch(s.token) {
                        case TokenType::Semicolon:
                            ...
                            break;
                        case TokenType::Dot:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Dot, std::move(s.value));
                            states.push_back(15);
                            read_token = true;
                            break;
                        default:
                ...
                case 17:
                    switch(s.token) {
                        case TokenType::OpenBrace:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::OpenBrace, std::move(s.value));
                            states.push_back(18);
                            read_token = true;
                            break;
                        case TokenType::Dot:
                ...
                case 18:
                    switch(s.token) {
                        case TokenType::Automata:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Automata, std::move(s.value));
                            states.push_back(19);
                            read_token = true;
                            break;
                        case TokenType::Set:
                            ...
                            break;
                        case TokenType::Enum:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Enum, std::move(s.value));
                            states.push_back(22);
                            read_token = true;
                            break;
                        case TokenType::Pattern:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Pattern, std::move(s.value));
                            states.push_back(24);
                            read_token = true;
                            break;
                        default:
                ...
                case 20:
                    switch(s.token) {
                        ...
                        case TokenType::CloseBrace:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::CloseBrace, std::move(s.value));
                ...
                case 26:
                    switch(s.token) {
                        case TokenType::ReStart:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::ReStart, std::move(s.value));
                            states.push_back(27);
                            read_token = true;
                            break;
                        default:
                ...
                case 27:
                    switch(s.token) {
                        ...
                        case TokenType::CharClass:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::CharClass, std::move(s.value));
                            states.push_back(32);
                            read_token = true;
                            break;
                        case TokenType::OpenSquare:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::OpenSquare, std::move(s.value));
                            states.push_back(33);
                            read_token = true;
                            break;
                        case TokenType::Char:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Char, std::move(s.value));
                            states.push_back(34);
                            read_token = true;
                            break;
                        case TokenType::OpenParenthesis:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::OpenParenthesis, std::move(s.value));
                            states.push_back(35);
                            read_token = true;
                            break;
                        default:
                ...
                case 29:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(lexical_type::NamespaceItem(), std::shared_ptr<NamespaceItemAst>(new PatternAst(span(i1.tkn_span.begin, i5.tkn_span.end), std::move(i2.Ident), std::move(i4.Re))));
                        read_token = false;
                        switch(states.back()) {
                            case 18: states.push_back(23); break;
                            case 20: states.push_back(104); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                ...
                case 33:
                    switch(s.token) {
                        case TokenType::Hat:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Hat, std::move(s.value));
                            states.push_back(54);
                            read_token = true;
                            break;
                        case TokenType::Char:
                ...
                case 34:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(lexical_type::ReText(), std::shared_ptr<ReAst>(new CharReAst(i1.tkn_span, spanvalue<wchar_t>(i1.tkn_span, i1.tkn_value[0]))));
                        read_token = false;
                        switch(states.back()) {
                            case 27: states.push_back(36); break;
                            case 35: states.push_back(52); break;
                ...
                case 36:
                    switch(s.token) {
                        ...
                        case TokenType::ReEnd:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::ReEnd, std::move(s.value));
                            states.push_back(37);
                            read_token = true;
                            break;
                        case TokenType::Asterisk:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Asterisk, std::move(s.value));
                            states.push_back(38);
                            read_token = true;
                            break;
                        case TokenType::Question:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Question, std::move(s.value));
                            states.push_back(39);
                            read_token = true;
                            break;
                        case TokenType::Pipe:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Pipe, std::move(s.value));
                            states.push_back(40);
                            read_token = true;
                            break;
                        case TokenType::Plus:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Plus, std::move(s.value));
                            states.push_back(41);
                            read_token = true;
                            break;
                        case TokenType::Char:
                ...
                case 37:
                    ...
                    if (true) {
                        ...
                        switch(states.back()) {
                            ...
                            case 74: states.push_back(77); break;
                            case 78: states.push_back(77); break;
                            case 108: states.push_back(77); break;
                            case 109: states.push_back(77); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                ...
                case 42:
                    switch(s.token) {
                        case TokenType::Number:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Number, std::move(s.value));
                            states.push_back(44);
                            read_token = true;
                            break;
                        case TokenType::Identifier:
                ...
                case 44:
                    switch(s.token) {
                        case TokenType::Comma:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Comma, std::move(s.value));
                            states.push_back(47);
                            read_token = true;
                            break;
                        case TokenType::CloseBrace:
                ...
                case 52:
                    switch(s.token) {
                        ...
                        case TokenType::CloseParenthesis:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::CloseParenthesis, std::move(s.value));
                            states.push_back(53);
                            read_token = true;
                            break;
                        case TokenType::OpenSquare:
                ...
                case 55:
                    switch(s.token) {
                        case TokenType::Hyphen:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Hyphen, std::move(s.value));
                            states.push_back(61);
                            read_token = true;
                            break;
                        default:
                            ...
                            if (true) {
                                ...
                                values.pop_back();
                                states.pop_back();
                                 values.emplace_back(lexical_type::CharRange(), std::shared_ptr<CharSetAst>(new SingleCharAst(i1.tkn_span, spanvalue<wchar_t>(i1.tkn_span, i1.tkn_value[0]))));
                                read_token = false;
                                switch(states.back()) {
                                    case 33: states.push_back(57); break;
                                    case 54: states.push_back(57); break;
                                    case 58: states.push_back(59); break;
                                    case 63: states.push_back(59); break;
                                    default: assert(false); states.push_back(0); break;
                                }
                            }
                            break;
                ...
                case 57:
                    ...
                    if (true) {
                        ...
                        read_token = false;
                        switch(states.back()) {
                            case 33: states.push_back(58); break;
                            case 54: states.push_back(63); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                case 58:
                    switch(s.token) {
                        ...
                        case TokenType::CloseSquare:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::CloseSquare, std::move(s.value));
                            states.push_back(60);
                            read_token = true;
                            break;
                        default:
                ...
                case 62:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(lexical_type::CharRange(), std::shared_ptr<CharSetAst>(new CharRangeAst(span(i1.tkn_span.begin, i3.tkn_span.end), spanvalue<wchar_t>(i1.tkn_span, i1.tkn_value[0]), spanvalue<wchar_t>(i3.tkn_span, i3.tkn_value[0]))));
                        read_token = false;
                        switch(states.back()) {
                            case 33: states.push_back(57); break;
                            case 54: states.push_back(57); break;
                ...
                case 67:
                    ...
                    if (true) {
                        ...
                        read_token = false;
                        switch(states.back()) {
                            case 66: states.push_back(68); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                ...
                case 71:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(lexical_type::NamespaceItem(), std::shared_ptr<NamespaceItemAst>(new EnumAst(span(i1.tkn_span.begin, i6.tkn_span.end), std::move(i2.Ident), std::move(i4.EnumItems))));
                        read_token = false;
                        switch(states.back()) {
                            case 18: states.push_back(23); break;
                            case 20: states.push_back(104); break;
                ...
                case 74:
                    switch(s.token) {
                        case TokenType::Include:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Include, std::move(s.value));
                            states.push_back(75);
                            read_token = true;
                            break;
                        case TokenType::ReStart:
                ...
                case 76:
                    ...
                    if (true) {
                        ...
                        read_token = false;
                        switch(states.back()) {
                            case 74: states.push_back(78); break;
                            case 108: states.push_back(109); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                case 77:
                    switch(s.token) {
                        case TokenType::Goto:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Goto, std::move(s.value));
                            states.push_back(82);
                            read_token = true;
                            break;
                        case TokenType::Return:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::Return, std::move(s.value));
                            states.push_back(83);
                            read_token = true;
                            break;
                        case TokenType::ProducedBy:
                            values.emplace_back(span(std::move(s.begin), std::move(s.end)), TokenType::ProducedBy, std::move(s.value));
                            states.push_back(84);
                            read_token = true;
                            break;
                        default:
                ...
                case 81:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(lexical_type::NamespaceItem(), std::shared_ptr<NamespaceItemAst>(new SetAst(span(i1.tkn_span.begin, i6.tkn_span.end), std::move(i2.Ident), std::move(i4.SetItems))));
                        read_token = false;
                        switch(states.back()) {
                            case 18: states.push_back(23); break;
                            case 20: states.push_back(104); break;
                ...
                case 87:
                    ...
                    if (true) {
                        ...
                        read_token = false;
                        switch(states.back()) {
                            case 74: states.push_back(76); break;
                            case 78: states.push_back(79); break;
                            case 108: states.push_back(76); break;
                            case 109: states.push_back(79); break;
                            default: assert(false); states.push_back(0); break;
                        }
                    }
                    break;
                ...
                case 111:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(lexical_type::NamespaceItem(), std::shared_ptr<NamespaceItemAst>(new AutomataAst(span(i1.tkn_span.begin, i6.tkn_span.end), std::move(i2.Ident), std::move(i4.SetItems))));
                        read_token = false;
                        switch(states.back()) {
                            case 18: states.push_back(23); break;
                            case 20: states.push_back(104); break;
                ...
                case 112:
                    ...
                    if (true) {
                        ...
                        values.pop_back();
                        states.pop_back();
                         values.emplace_back(); i2.DocumentItem->accept(processor); if(!ok) return false;
                        read_token = false;
                        switch(states.back()) {
                            case 0: states.push_back(1); break;
                            default: assert(false); states.push_back(0); break;
