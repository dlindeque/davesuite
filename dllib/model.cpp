...
namespace davelexer
{
    //inline auto write_qname(std::wostream &os, const qname &qn) -> std::wostream& {
    //    bool first = true;
    //    for (auto &n : qn) {
    //        if (first) {
    //            first = false;
    ...
    //        _os << L"import ";
    //        write_qname(_os, ast->section_to_import());
    //    }
    ...
    //        _os << L"token " << ast->token_name() << L" goto ";
    //        write_qname(_os, ast->section_name()) << L" = " << ast->ast();
    //    }
